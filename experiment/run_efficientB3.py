...
from models import EfficientB0, EfficientB3
...
def exp_set1(weight_dir, log_dir):
    ...
    model = EfficientB3(num_classes=len(class_to_name), loss_fn=nn.CrossEntropyLoss()).to(device) #get your model
...
#LR E-3 + CosineAnnealing + EfficientB3
...
#LR 5E-2 + MultiStepLR + EfficientB3
...
#LR E-3 + ReducePlateau + EfficientB3
